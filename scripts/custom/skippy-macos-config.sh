#!/usr/bin/env bash
# Based on macos file by Mathias Bynens
# ~/.macos — https://mths.be/macos
# Based on macos file by Matthias SPlieth
# https://github.com/splieth/dotfiles/blob/master/.macos
...
# (false to use the old Exposé behavior instead)
...
# Configure auto-hide and show of the Dock
...
# minimize to Desktop bottom-left
defaults write com.apple.dock wvous-bl-corner -int 4
defaults write com.apple.dock wvous-bl-modifier -int 0

# mission control to the upper right
defaults write com.apple.dock wvous-tr-corner -int 2
defaults write com.apple.dock wvous-tr-modifier -int 0

# lock screen to the lower right
